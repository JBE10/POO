...
public class Main {
    ...
    public static void ingresarEmpleado(){
        ...
        e.setSueldo(tecladoDos.nextDouble());
    ...
    public static void getEmpleado(){
        ...
        if (e==null){
            ...
            System.out.println("Legajo:"+e.getLegajo()+" Nombre:"+e.getNombre()+" Sueldo:"+ e.getSueldo());
        }
    ...
    public static void getMayorSueldo(){
        ...
        if (e==null){
            ...
            System.out.println("El legajo con mayor sueldo es: "+e.getLegajo()+" Su nomnbre es: "+e.getNombre()+" y su sueldo es: " +e.getSueldo());
        }
    }
